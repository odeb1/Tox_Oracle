...
const expected=new Set(['index.html','vercel.json',...['workspace.css','results-view.js','pose-viewer.js','public.css','public.js','public-model.js','public-review.js','toxoracle-logo.png'].map(n=>'static/'+n),'studies/index.json']);
