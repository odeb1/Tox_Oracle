...
We have built over this hack an agentic tool using NVIDIA BioNeMo and Rosalind/Codex that allows scientists to predict potential for DILI risk for novel compounds. This tool combines structure-based similairty predictions to known DILI drugs, and idneitfy potneitla key mechanisms from exposure data (_in vitro and in vivo_). 
